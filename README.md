* '**basvuru.sql**' dosyasını kullanarak uygulamaya ait veri tabanını içe aktarabilirsiniz.

* Veri tabanı bağlanma bilgilerini "basvuru/cont-body/uygulama/conn.php" dosyasından değiştirebilirsiniz.
